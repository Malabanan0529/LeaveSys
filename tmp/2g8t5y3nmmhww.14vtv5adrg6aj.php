...
" ?>
                                                        ...
                                                        <td class="py-4 text-xs text-zinc-500 font-mono text-right pr-2"><?= ($row['start_date']) ?> <span class="text-zinc-700 mx-1">→</span> <?= ($row['end_date']) ?></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
