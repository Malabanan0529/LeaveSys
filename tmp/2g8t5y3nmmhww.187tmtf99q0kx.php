...
<body class="h-screen flex items-center justify-center bg-zinc-950 text-zinc-100">
    ...
    <div class="w-full max-w-md p-8">
        ...
        <div class="text-center mb-10">
            ...
            <p class="text-zinc-500 text-sm mt-2">Join the Leave Management System</p>
        </div>
        ...
        <div class="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800/50 rounded-2xl p-8 shadow-xl">
            <form id="registerForm" class="space-y-5">
                <div class="space-y-1">
                    <label class="block text-xs font-medium text-zinc-400 uppercase tracking-wider">Full Name</label>
                ...
                <div class="space-y-1">
                    <label class="block text-xs font-medium text-zinc-400 uppercase tracking-wider">Confirm Password</label>
                    <div class="relative">
                        <input type="password" name="confirm_password" id="confirm_password"
                            class="w-full bg-zinc-950 border border-zinc-800 rounded-lg pl-4 pr-10 py-3 text-white placeholder-zinc-600 focus:outline-none focus:border-zinc-500 focus:ring-1 focus:ring-zinc-500 transition-all duration-200" 
                            placeholder="••••••••" required>
                        <button type="button" id="toggleConfirmPassword" class="absolute inset-y-0 right-0 flex items-center px-3 text-zinc-500 hover:text-zinc-300 transition-colors focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"/>
                                <circle cx="12" cy="12" r="3"/>
                            </svg>
        ...
        <div class="text-center mt-8">
            <p class="text-zinc-500 text-sm">
                ...
                <a href="<?= ($BASE) ?>/" class="text-white hover:text-zinc-300 font-medium transition-colors">Sign In</a>
            </p>
        </div>
    </div>
